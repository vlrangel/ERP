...
//1307
{
    ...
    dataset
    {
        dataitem(Header; "Sales Cr.Memo Header")
        {
            ...
            begin
                ...
                ////////nombre proyecto
                histLineAbono.SetRange("Document No.", Header."No.");
                if histLineAbono.FindFirst() then begin
                    //// Cód. proyecto
                    JobNo := histLineAbono."Job No.";
                    job.SetRange("No.", histLineAbono."Job No.");
    ...
    begin
        GLSetup.Get();
        CompanyInfo.SetAutoCalcFields(Picture, CompanyInfo."Logo ISO 1", CompanyInfo."Logo ISO 2", CompanyInfo.Sello);
        CompanyInfo.Get();
        SalesSetup.Get();
    ...
    var
        ...
        //<<
        histLineAbono: Record "Sales Cr.Memo Line";
        job: Record Job;
        bJobVisible: Boolean;
        legalTextTxt: Text;
        ...
        nAbonoLbl: Label 'CREDIT MEMO NO.';
